...
export default function EventManagement() {
  ...
  const [rescheduleForm, setRescheduleForm] = useState({ eventStartDate: '', eventEndDate: '' });
  ...
  const resetForm = () => {
    setForm({ name: '', description: '', eventStartDate: '', eventEndDate: '', location: '' });
        ...
        <div className="modal-overlay animate-fade-in">
          <div className="modal-content animate-fade-in-up" style={{ maxWidth: '500px' }}>
            ...
            <div className="modal-body">
              ...
              <div className="form-group">
                <label className="form-label" htmlFor="reschedule-start">Tanggal Mulai Baru *</label>
                <input
                  type="datetime-local"
                  id="reschedule-start"
                  className="form-input"
                  value={rescheduleForm.eventStartDate}
                  onChange={(e) => setRescheduleForm({ ...rescheduleForm, eventStartDate: e.target.value })}
                />
              </div>

              <div className="form-group">
                <label className="form-label" htmlFor="reschedule-end">Tanggal Selesai Baru *</label>
                <input
                  type="datetime-local"
                  id="reschedule-end"
                  className="form-input"
                  value={rescheduleForm.eventEndDate}
                  onChange={(e) => setRescheduleForm({ ...rescheduleForm, eventEndDate: e.target.value })}
                />
              </div>
